...
#### import data ####
# Read in file, delete not needed columns ####
data_all <- read.csv("data/R_data_all+AutLvl_comparisons.csv", encoding = "UTF-8")
# load("data/R_data_all+AutLvl_comparisons.RData")
