...
tab_aov_UEQ_Attractiveness <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Attractiveness, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
...
tab_aov_UEQ_Perspicuity <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Perspicuity, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
...
tab_aov_UEQ_Efficiency <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Efficiency, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
...
tab_aov_UEQ_Dependability <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Dependability, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
...
tab_aov_UEQ_Novelty <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Novelty, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
...
tab_aov_UEQ_Stimulation <- data.frame(matrix(unlist(EtaSq(anova_UEQ_Stimulation, type = 2, anova = TRUE)), nrow=1, byrow=TRUE),stringsAsFactors=FALSE)
