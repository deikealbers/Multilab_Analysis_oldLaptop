...
mid_tab_n2 <- mid_tab_n1 %>%
  ...
  mutate(across(ends_with("_ER"), ~case_when(
    ...
    . == '5 - Hilfe vom Experimenter; Mehrere Fehler Massive Fehler erfordern einen Neustart der Aufgabe, Hilfe des Experimentators erforderlich;' ~"5", #nur in TC03   
    TRUE ~ as.character(.))))
...
#### save data #### 
write_excel_csv(data_exp02, "data/preprocessed/preprocessed_Lime_exp02.csv")
